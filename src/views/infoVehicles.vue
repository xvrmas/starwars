            ...
            <div class="columns">
                ...
                <div class="column has-text-left is-half mt-3">
                    <div class="box">
                        ...
                        <p><strong>Cost in credits: </strong> {{ getInfoVehicles.cost_in_credits }}</p>
                        <p><strong>Lenght: </strong> {{ getInfoVehicles.length }}</p>
                        <p><strong>Crew: </strong> {{ getInfoVehicles.crew }}</p>
